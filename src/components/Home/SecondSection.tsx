...
const SecondSection = () => {
	return (
		<>
			<div className="w-full h-full bg-gradient-to-br from-red-200 to-red-100 grid grid-cols-2 md:place-items-center md:p-0">
				<div className="w-full h-full text-base flex flex-col justify-center items-center text-center p-2 gap-4 md:gap-12">
					...
					<button
						type="button"
						className=" bg-white rounded-lg p-2 w-fit transition-all duration-300 ease-in lg:p-4 hover:bg-red-200 hover:text-white md:text-xl"
					>
			...
			<div className="w-full h-full bg-gradient-to-br from-orange-200 to-red-300 grid grid-cols-2 md:place-items-center md:p-0">
				<div className="h-full w-full">
					<img
						src={alisados}
						alt="Servicios"
				...
				<div className="w-full h-full text-base flex flex-col justify-center items-center text-center p-2 gap-4 md:gap-12">
					...
					<button
						type="button"
						className="bg-white rounded-lg p-2 w-fit transition-all duration-300 ease-in lg:p-4 hover:bg-red-300 hover:text-white md:text-xl"
					>
